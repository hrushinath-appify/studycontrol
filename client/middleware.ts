...
export const config = {
  matcher: [
     ...
     * - favicon files (favicon.svg, apple-touch-icon.svg, site.webmanifest)
     * - public files (public folder)
     */
    '/((?!api|_next/static|_next/image|favicon\\.svg|apple-touch-icon\\.svg|site\\.webmanifest|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)',
  ],
}

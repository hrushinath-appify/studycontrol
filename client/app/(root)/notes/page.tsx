  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30 dark:opacity-20">
        <div className="absolute top-20 left-20 w-72 h-72 bg-gradient-to-r from-orange-400 to-red-400 dark:from-orange-500/80 dark:to-red-500/80 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-xl animate-pulse" />
        <div className="absolute top-40 right-20 w-72 h-72 bg-gradient-to-r from-pink-400 to-purple-400 dark:from-pink-500/80 dark:to-purple-500/80 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-xl animate-pulse" style={{ animationDelay: '2s' }} />
        <div className="absolute bottom-20 left-1/2 w-72 h-72 bg-gradient-to-r from-red-400 to-orange-400 dark:from-red-500/80 dark:to-orange-500/80 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-xl animate-pulse" style={{ animationDelay: '4s' }} />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6">
            <Button
              ...
              variant="outline"
              className="group bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border-orange-200 dark:border-orange-700 hover:border-orange-300 dark:hover:border-orange-600 text-orange-700 dark:text-orange-300 font-semibold px-4 py-2 rounded-xl shadow-lg transition-all duration-300 hover:shadow-orange-500/25 hover:scale-105"
            >
          ...
          <div className="text-center space-y-8">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-full h-32 bg-gradient-to-r from-orange-600 via-red-600 to-pink-600 opacity-20 blur-3xl rounded-full animate-pulse" />
              </div>
              
              {/* Icon and Title */}
              <div className="relative flex flex-col items-center gap-6 mb-8">
                <div className="relative">
                  <div className="w-24 h-24 bg-gradient-to-br from-orange-600 via-red-600 to-pink-600 rounded-3xl flex items-center justify-center shadow-2xl shadow-orange-500/25 dark:shadow-orange-400/25 transform hover:scale-110 transition-all duration-300 backdrop-blur-sm border border-white/20 dark:border-white/10">
                ...
                <div className="space-y-4">
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight leading-none">
                    <span className="block bg-gradient-to-r from-orange-600 via-red-600 to-pink-600 bg-clip-text text-transparent drop-shadow-sm">
                      Notes
                    </span>
                  </h1>
                  
                  <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
                    Create, organize, and manage your study notes with powerful editing tools, smart categorization, and seamless synchronization across all devices.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="relative p-6 bg-gradient-to-r from-yellow-100 via-orange-100 to-red-100 dark:from-yellow-900/30 dark:via-orange-900/30 dark:to-red-900/30 rounded-2xl border-2 border-yellow-300/50 dark:border-yellow-700/50 shadow-inner">
                    ...
                    <div className="relative text-center space-y-3">
                      ...
                      <p className="text-xl md:text-2xl font-black text-orange-700 dark:text-orange-300 leading-tight">
                        📝 10% of Overall Progress from Marrow Progress will unlock this Feature
                      </p>
                    </div>
                  </div>
            ...
            <Card className="max-w-2xl mx-auto bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl shadow-2xl shadow-orange-500/10 dark:shadow-orange-400/10 rounded-3xl overflow-hidden hover:shadow-orange-500/20 dark:hover:shadow-orange-400/20 transition-all duration-500 border border-orange-100/50 dark:border-orange-800/50">
              <CardContent className="p-8">
                <div className="space-y-6">
                  {/* Coming Soon Badge */}
                      ...
                      <span>
                        {isLoadingProgress 
                          ...
                          : currentProgress >= requiredProgress 
                            ? "🎉 Congratulations! You've unlocked the Notes feature!" 

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30 dark:opacity-20">
        <div className="absolute top-20 left-20 w-72 h-72 bg-gradient-to-r from-purple-400 to-violet-400 dark:from-purple-500/80 dark:to-violet-500/80 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-xl animate-pulse" />
        <div className="absolute top-40 right-20 w-72 h-72 bg-gradient-to-r from-violet-400 to-indigo-400 dark:from-violet-500/80 dark:to-indigo-500/80 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-xl animate-pulse" style={{ animationDelay: '2s' }} />
        <div className="absolute bottom-20 left-1/2 w-72 h-72 bg-gradient-to-r from-indigo-400 to-purple-400 dark:from-indigo-500/80 dark:to-purple-500/80 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-xl animate-pulse" style={{ animationDelay: '4s' }} />
          ...
          <div className="text-center space-y-8">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-full h-32 bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-600 opacity-20 blur-3xl rounded-full animate-pulse" />
              </div>
              
              {/* Icon and Title */}
              <div className="relative flex flex-col items-center gap-6 mb-8">
                <div className="relative">
                  <div className="w-24 h-24 bg-gradient-to-br from-purple-600 via-violet-600 to-indigo-600 rounded-3xl flex items-center justify-center shadow-2xl shadow-purple-500/25 dark:shadow-purple-400/25 transform hover:scale-110 transition-all duration-300 backdrop-blur-sm border border-white/20 dark:border-white/10">
                ...
                <div className="space-y-4">
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight leading-none">
                    <span className="block bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-600 bg-clip-text text-transparent drop-shadow-sm">
                      Diary
                    </span>
                  </h1>
                  
                  <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
                    Document your study journey, track daily progress, reflect on achievements, and maintain a personal record of your medical education experience.
                  </p>
                </div>
              </div>
            </div>
            ...
            <Card className="max-w-3xl mx-auto bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 backdrop-blur-xl shadow-2xl shadow-purple-500/10 dark:shadow-purple-400/10 rounded-3xl overflow-hidden hover:shadow-purple-500/20 dark:hover:shadow-purple-400/20 transition-all duration-500 border-2 border-purple-200/80 dark:border-purple-800/50">
              <CardContent className="p-8">
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-center gap-3">
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-purple-400 dark:to-indigo-400 bg-clip-text text-transparent">
                      Unlock Requirements
                    </h2>
                  </div>

                  {/* Main Requirement Text - Highlighted */}
                  <div className="relative p-6 bg-gradient-to-r from-yellow-100 via-purple-100 to-indigo-100 dark:from-yellow-900/30 dark:via-purple-900/30 dark:to-indigo-900/30 rounded-2xl border-2 border-yellow-300/50 dark:border-yellow-700/50 shadow-inner">
                    <div className="absolute inset-0 bg-gradient-to-r from-yellow-300/20 to-purple-300/20 rounded-2xl animate-pulse" />
                    <div className="relative text-center space-y-3">
                      ...
                      <p className="text-xl md:text-2xl font-black text-purple-700 dark:text-purple-300 leading-tight">
                        📖 15% of Overall Progress from Marrow Progress will unlock this Feature
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="p-1 rounded-md hover:bg-purple-100 dark:hover:bg-purple-900/20 transition-colors disabled:opacity-50"
                          title="Refresh progress"
                        >
                          <BarChart3 className={`w-3 h-3 text-purple-500 ${isLoadingProgress ? 'animate-pulse' : ''}`} />
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="relative pt-6">
                      ...
                      <div className="absolute -top-1 left-0 flex items-center gap-1 text-xs text-purple-600 dark:text-purple-400 font-semibold mb-2">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                    <Button
                      ...
                      className="group bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-bold px-6 py-3 rounded-xl shadow-lg transition-all duration-300 hover:scale-105"
                    >
            ...
            <Card className="max-w-2xl mx-auto bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl shadow-2xl shadow-purple-500/10 dark:shadow-purple-400/10 rounded-3xl overflow-hidden hover:shadow-purple-500/20 dark:hover:shadow-purple-400/20 transition-all duration-500 border border-purple-100/50 dark:border-purple-800/50">
              <CardContent className="p-8">
                <div className="space-y-6">
                  {/* Coming Soon Badge */}
                  <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-yellow-400 to-purple-500 text-white rounded-full font-semibold text-sm shadow-lg">
                  ...
                  <div className="relative space-y-6">
                    ...
                    <div className="absolute inset-0 overflow-hidden rounded-2xl">
                      <div className="absolute top-4 left-4 w-16 h-16 bg-gradient-to-br from-yellow-400/20 to-purple-500/20 rounded-full animate-bounce" style={{ animationDelay: '0s' }} />
                      <div className="absolute top-8 right-8 w-12 h-12 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-full animate-bounce" style={{ animationDelay: '1s' }} />
                      <div className="absolute bottom-4 left-1/2 w-8 h-8 bg-gradient-to-br from-pink-500/20 to-yellow-400/20 rounded-full animate-bounce" style={{ animationDelay: '2s' }} />
                    </div>

                    {/* Main Coming Soon Content */}
                    <div className="relative text-center space-y-4 p-8 bg-gradient-to-br from-yellow-50 via-purple-50 to-pink-50 dark:from-yellow-900/10 dark:via-purple-900/10 dark:to-pink-900/10 rounded-2xl border-2 border-yellow-200/50 dark:border-yellow-700/30 shadow-inner">
                      <div className="space-y-4">
                        {/* Animated rocket icon */}
                        <div className="flex justify-center">
                          <div className="relative">
                            <div className="w-20 h-20 bg-gradient-to-br from-yellow-400 via-purple-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-xl transform hover:scale-110 transition-all duration-300 animate-pulse">
                        ...
                        <div className="space-y-2">
                          <h3 className="text-3xl md:text-4xl font-black bg-gradient-to-r from-yellow-500 via-purple-500 to-pink-500 bg-clip-text text-transparent animate-pulse">
                            Coming Soon
                          </h3>
                        ...
                        <div className="flex justify-center gap-4 mt-6">
                          {[
                            ...
                            { label: 'Hours', value: '??', color: 'from-purple-400 to-pink-400' },
                            { label: 'Minutes', value: '??', color: 'from-pink-400 to-red-400' }
                          ].map((item, index) => (
                            <div
                              key={item.label}
                        ...
                        <div className="mt-6 p-4 bg-white/50 dark:bg-gray-800/50 rounded-xl border border-white/20 dark:border-gray-700/20 backdrop-blur-sm">
                          <p className="text-sm text-gray-700 dark:text-gray-300 italic">
                            &ldquo;Get ready for a revolutionary study experience that will transform how you track your medical journey! 🚀✨&rdquo;
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <span>
                        {isLoadingProgress 
                          ...
                          : currentProgress >= requiredProgress 
                            ? "🎉 Congratulations! You've unlocked the Diary feature!" 

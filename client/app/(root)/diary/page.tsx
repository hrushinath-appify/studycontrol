                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid gap-3">
                      {[
                        ...
                        "Achievement milestones recording",
                        "Photo and media attachments",
                        "Calendar view for easy navigation",
                        "Study habit analysis and insights",
                        "Export and backup options"
                      ].map((feature, index) => (
                        <div
                          key={index}
                          className="flex items-center gap-3 p-3 bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-xl border border-purple-100/50 dark:border-purple-800/30 opacity-60"

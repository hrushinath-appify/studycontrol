                ...
                <div className="space-y-6">
                  ...
                  <div className="relative space-y-6">
                    ...
                    <div className="absolute inset-0 overflow-hidden rounded-2xl">
                      <div className="absolute top-4 left-4 w-16 h-16 bg-gradient-to-br from-blue-400/20 to-purple-500/20 rounded-full animate-bounce" style={{ animationDelay: '0s' }} />
                      <div className="absolute top-8 right-8 w-12 h-12 bg-gradient-to-br from-purple-500/20 to-indigo-500/20 rounded-full animate-bounce" style={{ animationDelay: '1s' }} />
                      <div className="absolute bottom-4 left-1/2 w-8 h-8 bg-gradient-to-br from-indigo-500/20 to-blue-400/20 rounded-full animate-bounce" style={{ animationDelay: '2s' }} />
                    </div>

                    {/* Main Coming Soon Content */}
                    <div className="relative text-center space-y-4 p-8 bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-50 dark:from-blue-900/10 dark:via-purple-900/10 dark:to-indigo-900/10 rounded-2xl border-2 border-blue-200/50 dark:border-blue-700/30 shadow-inner">
                      <div className="space-y-4">
                        {/* Animated rocket icon */}
                        <div className="flex justify-center">
                          <div className="relative">
                            <div className="w-20 h-20 bg-gradient-to-br from-blue-400 via-purple-500 to-indigo-500 rounded-2xl flex items-center justify-center shadow-xl transform hover:scale-110 transition-all duration-300 animate-pulse">
                              <Zap className="w-10 h-10 text-white animate-bounce" />
                            </div>
                            {/* Rocket trail effect */}
                            <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-2 h-8 bg-gradient-to-t from-blue-400 to-transparent rounded-full animate-pulse opacity-60" />
                          </div>
                        </div>

                        {/* Coming Soon Text with gradient animation */}
                        <div className="space-y-2">
                          <h3 className="text-3xl md:text-4xl font-black bg-gradient-to-r from-blue-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent animate-pulse">
                            Coming Soon
                          </h3>
                        ...
                        <div className="flex justify-center gap-4 mt-6">
                          {[
                            { label: 'Days', value: '??', color: 'from-blue-400 to-purple-400' },
                            { label: 'Hours', value: '??', color: 'from-purple-400 to-indigo-400' },
                            { label: 'Minutes', value: '??', color: 'from-indigo-400 to-blue-400' }
                          ].map((item, index) => (
                            <div
                              key={item.label}
                        ...
                        <div className="mt-6 p-4 bg-white/50 dark:bg-gray-800/50 rounded-xl border border-white/20 dark:border-gray-700/20 backdrop-blur-sm">
                          <p className="text-sm text-gray-700 dark:text-gray-300 italic">
                            &ldquo;Get ready for an intelligent task management system that will revolutionize how you organize your medical studies! 🚀✨&rdquo;
                          </p>
                        </div>
                      </div>
                    </div>
